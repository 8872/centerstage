...
public class ZoneDetectionProcessor implements VisionProcessor, CameraStreamSource {
    ...
    public Object processFrame(Mat input, long captureTimeNanos) {
        ...
        Imgproc.line(input, new Point(x1, 0), new Point(x1, 720), BLACK, 4);
        Imgproc.line(input, new Point(x2, 0), new Point(x2, 720), BLACK, 4);
        Imgproc.line(input, new Point(x3, 0), new Point(x3, 720), BLACK, 4);
        ...
        Imgproc.rectangle(input, left, BLUE);
        Imgproc.rectangle(input, center, BLUE);
        Imgproc.rectangle(input, right, BLUE);
